    ...
    <nav className="w-full py-8 border-t border-brand-hairline">
      <div className={
        ...
        {p.layoutStyle === "minimal" ? (
          ...
          <div className="flex-1 flex gap-4 items-center group cursor-pointer hover:bg-brand-canvas-soft dark:hover:bg-neutral-800/50 p-4 rounded-lg transition-colors text-brand-ink dark:text-white">
            <div className="w-10 h-10 flex items-center justify-center rounded-full bg-brand-canvas dark:bg-neutral-900 border border-brand-hairline dark:border-white/10 text-brand-mute group-hover:text-brand-ink dark:group-hover:text-white group-hover:border-brand-hairline-strong transition-all shrink-0">
              <ArrowLeft size={18} />
            </div>
            <div className="flex-1 min-w-0">
              <span className="block text-[10px] font-mono uppercase tracking-wider text-brand-mute">Previous</span>
          ...
          <div className="flex-1 text-left cursor-pointer group py-4">
            <span className="block text-sm font-semibold text-brand-mute group-hover:text-brand-ink transition-colors mb-3">
              &larr; Previous Article
            </span>
            <h4 className="text-2xl md:text-3xl lg:text-4xl font-bold text-brand-ink dark:text-white leading-tight tracking-tight group-hover:text-brand-link transition-colors">
              Designing modern UI systems with Tailwind CSS
            </h4>
            {p.showExcerpt && (
              <p className="text-base text-brand-body mt-4 line-clamp-2 max-w-lg">
                A practical guide to tokenization and layout architectures.
              </p>
            )}
          </div>
          ...
          <div className="flex gap-4 items-center p-4 bg-brand-canvas dark:bg-neutral-900 text-brand-ink dark:text-white border border-brand-hairline dark:border-white/10 rounded-md shadow-level-1 hover:border-brand-hairline-strong transition-all cursor-pointer group">
            ...
            <div className="flex-1 min-w-0">
              ...
              <h4 className="text-xs font-semibold text-brand-ink dark:text-white leading-snug truncate mt-0.5 group-hover:text-brand-link transition-colors">
                Designing modern UI systems with Tailwind CSS
              </h4>
              {p.showExcerpt && (
        ...
        {p.layoutStyle === "minimal" ? (
          <div className="flex-1 text-right cursor-pointer group">
            <span className="inline-flex items-center justify-end gap-1 text-[10px] font-mono uppercase tracking-wider text-brand-mute group-hover:text-brand-ink transition-colors">
          ...
          <div className="flex-1 flex gap-4 flex-row-reverse items-center group cursor-pointer hover:bg-brand-canvas-soft dark:hover:bg-neutral-800/50 p-4 rounded-lg transition-colors text-right text-brand-ink dark:text-white">
            <div className="w-10 h-10 flex items-center justify-center rounded-full bg-brand-canvas dark:bg-neutral-900 border border-brand-hairline dark:border-white/10 text-brand-mute group-hover:text-brand-ink dark:group-hover:text-white group-hover:border-brand-hairline-strong transition-all shrink-0">
              <ArrowRight size={18} />
            </div>
            <div className="flex-1 min-w-0">
              <span className="block text-[10px] font-mono uppercase tracking-wider text-brand-mute">Next</span>
          ...
          <div className="flex-1 text-right cursor-pointer group py-4 flex flex-col items-end">
            ...
            <h4 className="text-2xl md:text-3xl lg:text-4xl font-bold text-brand-ink dark:text-white leading-tight tracking-tight group-hover:text-brand-link transition-colors text-right">
              Optimizing Ghost themes for 100/100 Lighthouse
            </h4>
            {p.showExcerpt && (
              <p className="text-base text-brand-body mt-4 line-clamp-2 max-w-lg text-right">
                Essential techniques for asset minification and responsive images.
              </p>
            )}
          </div>
