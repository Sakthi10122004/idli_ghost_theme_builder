...
export interface LogoCloudProps {
  general: {
    ...
    dynamicLinkSource?: "post" | "excerpt";
...
export const DEFAULT_LOGOS = [
  {
    ...
    linkUrl: "https://example.com/acme",
  },
  {
    id: "logo-2",
    name: "Apex Global",
  ...
  },
  {
    ...
    linkUrl: "https://example.com/boltflow",
  },
  {
    id: "logo-4",
    name: "Nexus AI",
    ...
    linkUrl: "https://example.com/nexus",
  },
  {
    id: "logo-5",
    name: "Vertex Labs",
  ...
  },
  {
    ...
    linkUrl: "https://example.com/pulsedata",
  },
];
...
export function resolveLogoCloudProps(props?: Record<string, unknown>): LogoCloudProps {
  ...
  const general: Partial<LogoCloudProps["general"]> = p?.general || {};
  return {
    general: {
      ...defaultProps.general,
      ...general,
      logoHeight: typeof general.logoHeight === "number" && general.logoHeight > 0 ? general.logoHeight : 36,
      enableLinks: general.enableLinks !== false,
      openInNewTab: general.openInNewTab !== false,
      dynamicLinkSource: general.dynamicLinkSource || "excerpt",
